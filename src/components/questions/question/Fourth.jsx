            ...
            <div className="question__wrapper">
                <div className="input__wrapper">
                    <div className="input_textarea_wrapper">
                        ...
                        <div>
                            <TextArea value={data.expectedSalary} style={data.expectedSalary.length !== 0 ? {borderColor: '#000'} : {borderColor: '#75778A'}} placeholder="Ваш ответ" border="3px solid" onChange={(e) => setData({ ...data, expectedSalary: e.target.value })} />
                    ...
                    <div className="input_textarea_wrapper">
                        ...
                        <div>
                            <TextArea value={data.comfortableSalary} style={data.comfortableSalary.length !== 0 ? {borderColor: '#000'} : {borderColor: '#75778A'}} placeholder="Ваш ответ" border="3px solid" onChange={(e) => setData({ ...data, comfortableSalary: e.target.value })} />
                    ...
                    <div className="input_textarea_wrapper">
                        ...
                        <div>
                            <TextArea value={data.minimumSalaryForLife} style={data.minimumSalaryForLife.length !== 0 ? {borderColor: '#000'} : {borderColor: '#75778A'}} placeholder="Ваш ответ" border="3px solid" onChange={(e) => setData({ ...data, minimumSalaryForLife: e.target.value })} />
